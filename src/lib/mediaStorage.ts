...
/**
 * Stores a file in IndexedDB and creates a usable URL
 */
export async function saveMediaFile(file: File): Promise<StoredMediaFile & { url: string }> {
  ...
  // Convert files under 15MB to DataURL for instant persistent serialization
